...
public class LeagueTableEntry {
    ...
    public static Builder builder(String teamName) {
        return new Builder(teamName);
    }
    ...
    public static class Builder {
        ...
        public void addHomeMatch(Match match) {
            ...
            addStat(goalsFor, goalsAgainst);
        }

        public void addAgainstMatch(Match match) {
            int goalsFor = match.getAwayScore();
            int goalsAgainst = match.getHomeScore();
            addStat(goalsFor, goalsAgainst);
        }

        private void addStat(int goalsFor, int goalsAgainst) {
            this.played++;
            ...
            this.points += getPoints(goalsFor, goalsAgainst);
            this.goalsFor += goalsFor;
            this.goalsAgainst += goalsAgainst;
            this.goalDifference += goalsFor - goalsAgainst;
        }

        private int getPoints(int goalsFor, int goalsAgainst) {
            if (goalsFor > goalsAgainst) {
                return 3;
            }
            if (goalsFor < goalsAgainst) {
        ...
        private Builder(String teamName) {
            this.teamName = teamName;
        }

        public LeagueTableEntry build() {
            return new LeagueTableEntry(this.teamName, this.played, this.won, this.drawn, this.lost, this.goalsFor,
